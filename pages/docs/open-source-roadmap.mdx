...
- <Link href="/docs/open-source-roadmap/glossary">[**Glossary**]</Link>
  - Step 1
  - What do all these weird terms from Git + GitHub mean? For example: [fork](/docs/open-source-roadmap/glossary#fork), [branch](/docs/open-source-roadmap/glossary#branch), [clone](/docs/open-source-roadmap/glossary#clone), [pull request](/docs/open-source-roadmap/glossary#pull-request), etc.
